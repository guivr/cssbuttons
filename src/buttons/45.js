...
function App() {
    return (
        <div id="viewer">
            <div class="f416">
                ...
                <div>
                    <pre className="prettyprint">{`<div><a href="/" tabindex="0"><img class="bn45" src="https://cdn.worldvectorlogo.com/logos/google-2.svg"alt="bn45"/></a></div>`}</pre>
                </div>
                <div>
  ...
  height: 60px;
                    ...
                    <pre className="prettyprint">{'https://cdn.worldvectorlogo.com/logos/google-2.svg'}</pre>
                </div>
            </div>
        </div>
    );
