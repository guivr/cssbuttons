...
function App() {
    return (
        <div id="viewer">
            <div class="f416">
                <h1 class="buttonh1">Button#10</h1>
                ...
                <h2 class="h2source">Source: <a href="https://www.w3schools.com/" class="avis" target="_blank" rel="noopener noreferrer">https://www.w3schools.com/</a> </h2>

                <div>
                    <pre className="prettyprint">{`<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">`}</pre>
                </div>
                <div>
                    <pre className="prettyprint">{`<a href="/"><button class="w3-button w3-black w3-round-small">Button</button></a>`}</pre>
                </div>
            </div>
        </div>
    );
