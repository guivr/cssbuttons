    ...
    return (
        <div id="viewer">
            <div className="f416">
                ...
                <a href="/buttons/10"><button className="w3-button w3-black w3-round-small">Button</button></a>
                ...
                <h2 className="h2source">Source: <a href="https://www.w3schools.com/" className="avis" target="_blank" rel="noopener noreferrer">https://www.w3schools.com/</a> </h2>
