...
function App() {
    return (
        <div id="viewer">
            <div className="f416">
                <h1 className="buttonh1">Button#24</h1>
                <a href="/buttons/24"><button className="bn632-hover bn24">Button</button></a>
                ...
                <div>
                    <pre className="prettyprint">{`<a href="/"><button className="bn632-hover bn24">Button</button></a>`}</pre>
                </div>
                <div>
