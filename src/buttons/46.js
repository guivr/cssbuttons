...
function App() {
    return (
        <div id="viewer">
            <div class="f416">
                <h1 class="buttonh1">Button#46</h1>
                ...
                <div>
                    <pre className="prettyprint">{`<div><a href="/" tabindex="0"><img class="bn46" src="https://developer.apple.com/app-store/marketing/guidelines/images/badge-example-preferred.png"alt="bn45"/></a></div>`}</pre>
                </div>
                <div>
