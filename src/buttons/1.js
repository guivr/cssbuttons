...
function App() {
    return (
        <div id="viewer">
            ...
            <h2 class="h2source">Source: <a href="https://fdossena.com/?p=html5cool/buttons/i.frag" class="avis" target="_blank" rel="noopener noreferrer"> https://fdossena.com/?p=html5cool/buttons/i.frag</a> </h2>
            <div>
                <pre className="prettyprint">{`<a href="/" class="bn1">Button</a>`}</pre>
            </div>
            <div>
